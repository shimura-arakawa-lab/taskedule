...
exports.NavigationButton = class extends react_1.Component {
    ...
    render() {
        ...
        return (<react_native_1.Button testID={button.testID} key={button.id} title={button.text || ''} onPress={() => button.enabled !== false &&
    ...
    renderButtonComponent() {
        ...
        <Component key={buttonComponentId} {...props} componentId={buttonComponentId} ref={(ref) => (this.ref = ref)}/>
